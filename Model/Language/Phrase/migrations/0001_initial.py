    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.fields.CharField(max_length=10, unique=True, verbose_name='组名')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cy', models.fields.CharField(db_index=True, max_length=20, verbose_name='词语')),
                ('py', models.fields.CharField(max_length=150, verbose_name='拼音')),
                ('number_py', models.fields.CharField(default=None, max_length=165, verbose_name='带数字带拼音')),
                ('clen', models.fields.PositiveIntegerField(verbose_name='词语长度')),
                ('plen', models.fields.PositiveIntegerField(help_text='不包含标点符号', verbose_name='净词语长度')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.fields.CharField(max_length=10, unique=True, verbose_name='标签')),
                ('start', models.fields.IntegerField(default=0, verbose_name='标注进展')),
            ],
            options={
                'abstract': False,
                'default_manager_name': 'objects',
