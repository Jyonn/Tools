...
Syllables = [
    ['a', 'ba', 'ca', 'cha', 'chua', 'da', 'dia', 'fa', 'ga', 'gua', 'ha', 'hua', 'jia', 'ka', 'kua', 'la', 'lia', 'ma', 'na', 'pa', 'qia', 'sa', 'sha', 'shua', 'ta', 'wa', 'xia', 'ya', 'za', 'zha', 'zhua'],
    ['ai', 'bai', 'cai', 'chai', 'chuai', 'dai', 'gai', 'guai', 'hai', 'huai', 'kai', 'kuai', 'lai', 'mai', 'nai', 'pai', 'sai', 'shai', 'shuai', 'tai', 'wai', 'zai', 'zhai', 'zhuai'],
    ...
    ['bie', 'die', 'jie', 'jue', 'lie', 'lüe', 'mie', 'nie', 'nüe', 'pie', 'qie', 'que', 'tie', 'xie', 'xue', 'ye', 'yue'],
    ['bin', 'jin', 'jun', 'lin', 'min', 'nin', 'pin', 'qin', 'xin', 'xun', 'yin', 'yun'],
    ['bing', 'ding', 'jing', 'ling', 'ming', 'ning', 'ping', 'qing', 'ting', 'xing', 'ying'],
    ['bo', 'chuo', 'cuo', 'duo', 'fo', 'guo', 'huo', 'kuo', 'lo', 'luo', 'mo', 'nuo', 'o', 'po', 'ruo', 'shuo', 'suo', 'tuo', 'wo', 'yo', 'zhuo', 'zuo'],
    ['bu', 'chu', 'cu', 'du', 'fu', 'gu', 'hu', 'ku', 'lu', 'mu', 'nu', 'pu', 'ru', 'shu', 'su', 'tu', 'wu', 'zhu', 'zu'],
    ['ce', 'che', 'de', 'e', 'ge', 'he', 'ke', 'le', 'me', 'ne', 're', 'se', 'she', 'te', 'ze', 'zhe'],
    ['chi', 'ci', 'ri', 'shi', 'si', 'zhi', 'zi'],
    ['chong', 'cong', 'dong', 'gong', 'hong', 'jiong', 'kong', 'long', 'nong', 'qiong', 'rong', 'song', 'tong', 'xiong', 'yong', 'zhong', 'zong'],
    ['chou', 'cou', 'dou', 'fou', 'gou', 'hou', 'kou', 'lou', 'mou', 'nou', 'ou', 'pou', 'rou', 'shou', 'sou', 'tou', 'zhou', 'zou'],
    ['chui', 'cui', 'dui', 'gui', 'hui', 'kui', 'shui', 'sui', 'tui', 'zhui', 'zui'],
    ['chun', 'cun', 'dun', 'gun', 'hun', 'kun', 'lun', 'qun', 'run', 'shun', 'sun', 'tun', 'zhun', 'zun'],
